<template>
  <div class="flex flex-col items-center bg-support-200">
    <nav
      ...
      "
    >
      <span :class="styleNav(1)" @click="navStatusMove(1)">My Tasks</span>
      <span :class="styleNav(2)" @click="navStatusMove(2)">In Progress</span>
      <span :class="styleNav(3)" @click="navStatusMove(3)">Completed</span>
    </nav>
          ...
          <template #item="{ element: item }">
            <div>
              ...
              <div
                ...
                :class="[
                  item.star ? 'bg-highlight-dark' : 'bg-support-100',
                  navStatus === 1 ? 'cursor-move' : 'cursor-default',
                ]"
                v-if="!item.edit"
              >
                <div class="flex justify-between">
                  <div class="">
                    ...
                    <span
                      class="text-xl ml-1.5 cursor-default"
                      :class="{
...
export default {
  ...
  methods: {
    ...
    navStatusMove(status) {
      this.navStatus = status;
      this.allowDrag = status === 1;
    },
  },
};
</script>
